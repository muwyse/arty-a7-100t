...
proc write_mig_file_design_1_mig_7series_0_2 { str_mig_prj_filepath } {
   ...
   puts $mig_prj_file {    <MMCMClkOut3>22</MMCMClkOut3>}
   puts $mig_prj_file {    <MMCMClkOut4>33</MMCMClkOut4>}
...
proc create_root_design { parentCell } {
  ...
  set clk_20M_o [ create_bd_port -dir O -type clk clk_20M_o ]
  set_property -dict [ list \
   CONFIG.FREQ_HZ {20181819} \
 ] $clk_20M_o
  ...
  set clk_55M_o [ create_bd_port -dir O -type clk clk_55M_o ]
  set_property -dict [ list \
   CONFIG.FREQ_HZ {55500000} \
 ] $clk_55M_o
  ...
  connect_bd_net -net mig_ddr_ui_addn_clk_2 [get_bd_ports clk_55M_o] [get_bd_pins mig_ddr/ui_addn_clk_2]
  connect_bd_net -net mig_ddr_ui_addn_clk_3 [get_bd_ports clk_30M_o] [get_bd_pins axi_clock_converter_0/s_axi_aclk] [get_bd_pins axi_protocol_convert_0/aclk] [get_bd_pins mig_ddr/ui_addn_clk_3] [get_bd_pins rst_s_axi/slowest_sync_clk]
  connect_bd_net -net mig_ddr_ui_addn_clk_4 [get_bd_ports clk_20M_o] [get_bd_pins mig_ddr/ui_addn_clk_4]
