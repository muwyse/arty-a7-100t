...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net mig_ddr_ui_addn_clk_1 [get_bd_ports clk_74M_o] [get_bd_pins axi_clock_converter_0/s_axi_aclk] [get_bd_pins axi_protocol_convert_0/aclk] [get_bd_pins mig_ddr/ui_addn_clk_1] [get_bd_pins rst_s_axi/slowest_sync_clk]
  ...
  connect_bd_net -net rst_s_axi_20M_interconnect_aresetn [get_bd_ports s_axi_reset_n_o] [get_bd_pins axi_clock_converter_0/s_axi_aresetn] [get_bd_pins axi_protocol_convert_0/aresetn] [get_bd_pins rst_s_axi/interconnect_aresetn]
  connect_bd_net -net rst_tie_high_dout [get_bd_pins rst_mig_ddr_83M/aux_reset_in] [get_bd_pins rst_s_axi/aux_reset_in] [get_bd_pins rst_tie_high/dout]
  connect_bd_net -net rst_tie_low_dout [get_bd_pins rst_mig_ddr_83M/mb_debug_sys_rst] [get_bd_pins rst_s_axi/mb_debug_sys_rst] [get_bd_pins rst_tie_low/dout]
