...
#
# arty-uart.tcl: Tcl script for re-creating project 'arty-uart'
#
#*****************************************************************************************
...
# Create design_1
set design_tcl "${origin_dir}/src/tcl/design_1_uart.tcl"
source ${design_tcl}
...
proc load_bp_sources_from_flist { origin_dir blackparrot_dir } {
  ...
  set flist_path "${origin_dir}/src/flist/uart.flist"
...
set obj [get_filesets sources_1]
set_property -name "top" -value "arty_uart" -objects $obj
...
set file "[file normalize "$origin_dir/src/xdc/constraints_uart.xdc"]"
set file_added [add_files -norecurse -fileset constrs_1 [list $file]]
set file "${origin_dir}/src/xdc/constraints_uart.xdc"
