...
#
# arty-parrot.tcl: Tcl script for re-creating project 'arty-parrot'
#
#*****************************************************************************************
...
proc checkRequiredFiles { origin_dir} {
 ...
 "[file normalize "$origin_dir/src/v/arty_bp.sv"]"\
...
set script_file "arty-parrot.tcl"
...
set obj [get_filesets sources_1]
set_property -name "top" -value "arty_bp" -objects $obj
